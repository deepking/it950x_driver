...
Dword User_busTx (
     ...
     */
	//Sleep(1);
    return (IT9507_writeGenericRegisters((Modulator*)demodulator->userData,((Modulator*)demodulator->userData)->slaveIICAddr, (Byte)bufferLength,buffer));
}
...
Dword User_busRx (
     ...
     */
	//Sleep(1);
    return (IT9507_readGenericRegisters((Modulator*)demodulator->userData, ((Modulator*)demodulator->userData)->slaveIICAddr, (Byte)bufferLength,buffer));
}
