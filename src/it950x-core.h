...
long it950x_usb_tx_unlocked_ioctl_dev(struct it950x_dev*, unsigned int, unsigned long);
...
long it950x_usb_rx_unlocked_ioctl_dev(struct it950x_dev*, unsigned int, unsigned long);
