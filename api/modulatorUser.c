...
DeviceDescription HwDesc[] =
{
	...
	{RestSlave, RfEnable, MuxSelect, UartTxd, PowerDownSlave, NA,			IrDa,   NA	},	//0:EVB-01 v01
	{RestSlave, RfEnable, NA,        UartTxd, PowerDownSlave, NA,			IrDa,   NA	},	//1:DB-01-01 v01
	{RestSlave, RfEnable, MuxSelect, UartTxd, PowerDownSlave, NA,			lnaGain,NA	},	//2:DB-01-02 v01
	{RestSlave, RfEnable, NA,        UartTxd, PowerDownSlave, NA,           IrDa,   NA			},	//3:DB-01-01 v03
	{RestSlave, RfEnable, MuxSelect, NA,      PowerDownSlave, NA,           NA,     NA			},	//4:DB-01-02 v03
	{NA,        NA,       NA,        NA,      NA,             NA,           NA,     NA			},	//5:SD AV sender
	{RestSlave, RfEnable, LoClk,     LoData,  LoLe,           LnaPowerDown, IrDa,   UvFilter	},	//6:EVB-01 v02
